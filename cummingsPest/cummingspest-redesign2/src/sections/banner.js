...
import logoImage from 'assets/cummings.png';
import bannerImage from 'assets/cummingsbees.png';
import bannerIcon1 from 'assets/cummingstermite.png';
import bannerIcon2 from 'assets/cummingsfly.png';
import bannerIcon3 from 'assets/cummingscockroach.png';
import bannerIcon4 from 'assets/cummingscockroach.png';
    ...
    <Box as="section" id="banner" sx={styles.banner}>
      <Container sx={styles.container}>
        <Image
          ...
          alt="Cummungs termite"
          src={bannerIcon1}
        />
        <Image
          sx={styles.bannerIcon2}
          className="bannerIcon"
          alt="cummings cockroaches"
          src={bannerIcon2}
        />
        <Image
        ...
        <Image sx={styles.logo} src={logoImage} alt="cummings termite and pest image" />
        <Heading as="h2">Cummings Termite and Pest</Heading>
        <p>THE PREFERRED PEST CONTROL COMPANY IN THE EAST VALLEY SINCE 1972</p>
        <Image src={bannerImage} sx={styles.bannerImage} alt="cummings rat" />
      </Container>
    </Box>
  );
};
